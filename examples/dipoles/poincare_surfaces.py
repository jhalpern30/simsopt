...
nfieldlines = 10 # Number of field lines for integration 
tmax_fl = 2000 # Maximum toroidal angle for integration
...
OUT_DIR = f'../single_stage_outputs/wout_nfp22ginsburg_000_000281/mpol=5-ntor=5_current_penalty_200000'
bs = load(OUT_DIR + f'/biot_savart_opt.json')

surf = load(OUT_DIR + f'/surf_opt.json')
# Extend surface, since we want to look at field lines beyond it
surf_extended = load(OUT_DIR + f'/surf_opt.json')
